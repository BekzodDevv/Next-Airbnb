...
function Header({ placeholder }) {
    ...
    const [notOfGuests, setNotOfGuests] = useState(1);
    ...
    return (
        ...
        grid-cols-3 bg-white shadow-md p-5">
            ...
            rounded-full py-2 md:shadow-sm">
                ...
                <input value={searchInput} onChange={(e) => setSearchInput(e.target.value)} type="text" className="flex-grow pl-5 bg-transparent 
                outline-none text-sm text-gray-600 placeholder-gray-400" placeholder={placeholder || "Start your search"} />
            ...
            {searchInput && (
                ...
                col-span-3 mx-auto">
                    ...
                    <div className="flex items-center border-b mb-4">
                        ...
                        <input
                            value={notOfGuests}
                            onChange={(e) => setNotOfGuests(e.target.value)}
                            min={1}
                            type="number"
